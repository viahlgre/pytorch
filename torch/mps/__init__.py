...
def load_safetensors(filename: str) -> dict[str, Tensor]:
    r"""Load a safetensors file directly to MPS device.

    Loads tensors from a safetensors file with optimized parallel I/O for MPS.
    Typically 2-3x faster than standard loading methods.
